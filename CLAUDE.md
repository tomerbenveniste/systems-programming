...
- `OrthogonalTriangle.h` — **DONE** (Carmi's skeleton, correct)
- `OrthogonalTriangle.cpp` — **DONE** (Tomer implemented)
- `Array.h` — **NEXT** (declared only, no implementation — template, implementation goes in the header)
